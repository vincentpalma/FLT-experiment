...
Serre's conjecture. Given this result, we can now prove Theorem~\ref{Wiles_Frey}:
\begin{proof}
  \proves{Wiles_Frey}
  \uses{Frey_curve_hardly_ramified,hardly_ramified_reducible}
  Indeed, the mod $p$ representation attached to the Frey package is hardly ramified by theorem~\ref{Frey_curve_hardly_ramified}
